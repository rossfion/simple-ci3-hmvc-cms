        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="form-signin" name="User Information" method="post" action="<?php echo base_url(); ?>registration/user_registration_information/">
                        <div class="form-group">
                            <label for="first_name">First Name</label>
                            <input type="text" class="form-control" name="first_name" placeholder="Enter your first name" required>
                            <input type="hidden" class="form-control" name="user_type" value="<?php echo "user"; ?>">
