        ...
        <!--        </div>-->
                <div class="col-md-12">
                    <table class="table table-hover">
                        ...
                        <?php
                        foreach ($viewprofileinfo as $value) {
                        ...
                        <td><img src="<?php echo base_url();?><?php echo $value->image_path;?>" height="100" width="100"></td>
                ...
                <?php
                 ...
                 ?>
                <font color="red"><h3>Erm...seems you need to create a profile?</h3></font>
                <?php
                    }
                    ?>
