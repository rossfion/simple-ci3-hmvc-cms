...
<html lang="en">
  <head>
    ...
    <title>Viewing About Us Page</title>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <h2><?php echo $view_aboutus->title;?></h2>
          <p><?php echo $view_aboutus->aboutus_content;?></p>
          <p><a class="btn btn-info" href="<?php echo base_url();?>user/editaboutus/<?php echo $view_aboutus->aboutus_id;?>" role="button">Edit &raquo;</a></p>
        </div>
