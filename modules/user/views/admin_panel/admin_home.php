...
<html lang="en">
    <head>
        ...
        <title>Welcome to Your Profile Admin Panel</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="alert alert-success">
                <h4>Welcome,
                    ...
                    <p>You are logged in as&nbsp;<?php echo $this->session->userdata('user_type');?></p>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <form class="form-horizontal form-signin" method="post" action="<?php echo base_url(); ?>profile/save_profileinformation.html" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" placeholder="Enter some info about yourself, your interests, and so on"></textarea>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <h3><font color="green">
                        <?php
                        $message = $this->session->userdata('save_profile');
                        if (isset($message)) {
                            echo $message;

                            $this->session->unset_userdata('save_profile');
                        }
                        ?>
                        </font></h3>

                    <a href="<?php echo base_url();?>user/viewprofileinformation.html" target="_blank"><button class="btn btn-primary">View Your Profile</button></a>
                </div>
            </div>
        ...
        <?php
        }elseif($this->session->userdata('user_type') === "super_admin"){
            ?>
        <?php
