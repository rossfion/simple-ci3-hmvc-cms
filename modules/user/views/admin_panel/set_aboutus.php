...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>aboutus/saveaboutuscontent.html">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="aboutus_content" placeholder="Enter content" required=""></textarea>
                    </div>
                </div>
                <div class="form-group">
