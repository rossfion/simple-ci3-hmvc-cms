...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>aboutus/updateaboutuscontent.html">
                <div class="form-group">
                    <label for="title" class="col-sm-2 text-right">Title</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="title" placeholder="Enter your title" required="" value="<?php echo $editaboutus->title; ?>">
                        <input type="hidden" name="user_id" class="form-control" value="<?php echo $editaboutus->user_id; ?>">
                        <input type="hidden" name="aboutus_id" class="form-control" value="<?php echo $editaboutus->aboutus_id; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="content" class="col-sm-2 text-right">Content</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="aboutus_content" placeholder="Enter content" required=""><?php echo $editaboutus->aboutus_content; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
