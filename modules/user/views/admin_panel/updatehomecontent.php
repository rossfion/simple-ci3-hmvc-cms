...
<html lang="en">
    <head>
        ...
        <title>Update &#124; Home Content</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>homecontent/updatehomecontent.html">
                <div class="form-group">
                    <label for="title" class="col-sm-2 text-right">Title</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="title" placeholder="Enter your title" required="" value="<?php echo $edithomecontent->title; ?>">
                        <input type="hidden" name="user_id" class="form-control" value="<?php echo $edithomecontent->user_id; ?>">
                        <input type="hidden" name="homecontent_id" class="form-control" value="<?php echo $edithomecontent->homecontent_id; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="content" class="col-sm-2 text-right">Content</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="home_content" placeholder="Enter content" required=""><?php echo $edithomecontent->home_content; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
